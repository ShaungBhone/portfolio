  ...
  <div class="container">
    <nav class="lg:flex lg:justify-between py-7 md:py-11">
      <div class="flex justify-between flex-col-reverse md:flex-row">
        ...
        <div class="my-auto lg:hidden flex justify-between">
          <div>
            <button
              type="button"
          ...
          <div class="md:hidden flex space-x-2">
            <NuxtLink
              class="my-auto"
              to="https://www.linkedin.com/in/shaungbhone/"
            >
              <svg
            ...
            <NuxtLink class="my-auto" to="https://github.com/ShaungBhone">
              <svg
                xmlns="http://www.w3.org/2000/svg"
      ...
      <div class="my-auto hidden lg:flex text-lg">
        <ul class="flex space-x-8">
          ...
          <li class="hover:text-gray-500 text-gray-900 my-auto">
            <NuxtLink to="https://github.com/ShaungBhone">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                xmlns:xlink="http://www.w3.org/1999/xlink"
                aria-hidden="true"
